...
namespace Aircraft
{
    ...
    {
        public int numLaps = 2; //Number of laps for this race
        public float checkpointBonusTime = 15f; //Bonus seconds to give upon reaching checkpoint
        ...
        private void Start()
        {
            ...
            Debug.Assert(virtualCamera != null, "Virtual camera is not specified");
        ...
        /// <summary>
        /// Start the countdown at the beginning of race
        /// </summary>
        ...
        private void OnStateChange()
        {
            if (GameManager.Instance.GameState == GameState.Playing)
            {
                //start.resume the game time, show the hud, thaw the agents
        ...
        private int PlaceComparer(AircraftAgent a, AircraftAgent b)
        {
            ...
            {
                //compare number of checkpoints hit.The agent with more checkpoint is
