...
namespace Aircraft
{
    ...
    {
        public TextMeshProUGUI placeText; //the place in the list(e.g. 1st)
        public TextMeshProUGUI timeText; // seconds remaining to reach next checkpoint
        public TextMeshProUGUI lapText; //the current lap(e.g. Lap 2)

        public Image checkpointIcon; //Icon indicating where the next checkpoint is
        public Image checkpointArrow; //the arrow pointing toward the next checkpoint
